...
public class UserCareerVO {
	...
	public String toString() {
		return "UserCareerVO [careerId=" + careerId + ", companyName=" + companyName + ", department=" + department
				+ ", position=" + position + ", startDate=" + startDate + ", endDate=" + endDate + ", attendingCheck="
				+ attendingCheck + ", hireType=" + hireType + ", seekerId=" + seekerId + "]";
	}
